...
import { TESTIMONIALSection, TESTIMONIALSectionItem, TESTIMONIALVariants } from 'src/_polly/components/src/sections'
...
export default function EditSectionTestimonialModal({
  ...
  const [sectionVariants, setSectionVariants] = useState<TESTIMONIALVariants[]>([])
  ...
  const handleVariantChange = (variant: TESTIMONIALVariants) => {
  ...
  return (
    <div>
      <ModalDialogV2 {...{ open, onBack }}>
        <div className="px-4 mt-3 space-y-5 pb-24">
          <h2 className="uppercase font-medium text-xl">TESTIMONIALS</h2>
