...
export default function VariantOne({ section }: { section: BlogSection }) {
  ...
  return (
    <div className=" bg-[black] lg:py-12 h-full w-full py-6 relative">
      <div className="flex flex-col lg:flex-row justify-between py-5 lg:px-10 text-[#eee]">
        <div className="lg:w-[540px] w-[280px]">
          <Swiper
            autoplay={{
              delay: 3000,
        ...
        <div className=" absolute lg:top-32 text-left top-12 lg:right-14 -right-12 z-10 lg:left-[510px] w-[200px] rotate-[270deg] mt-12  lg:h-[100px] ml-12 lg:rotate-[90deg]">
        ...
        <motion.div className=" lg:gap-y-12 px-4 lg:px-0 lg:ml-10 mt-10 w-[100%]">
          <div className=" overflow-hidden lg:ml-[160px]  lg:w-[80%]">
            <motion.p
